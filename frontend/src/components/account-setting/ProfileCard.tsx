            ...
            <div className="flex flex-col pb-[1.0rem] gap-[1.5rem]">
                ...
                <div className="flex flex-col gap-[2rem]">
                    ...
                    <div className="flex flex-col gap-[0.75rem]">
                        ...
                        <div className="w-full px-[1rem] py-[0.5rem] rounded-[0.5rem] bg-[var(--color-primary-400)] text-center">
                            <p className="text-[var(--color-common-white)] text-[1rem]">Sign out</p>
                        </div>
                        {/* TODO: Replace here with Button Component & Setup for preapre to sync with backend */}
