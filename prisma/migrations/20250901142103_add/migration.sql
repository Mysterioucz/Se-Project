-- DropIndex
DROP INDEX "public"."Flight_ArrivalAirportID_key";

-- DropIndex
DROP INDEX "public"."Flight_DepartureAirportID_key";

-- AlterTable
ALTER TABLE "public"."Flight" ALTER COLUMN "ArrivalAirportID" SET DATA TYPE VARCHAR(10),
ALTER COLUMN "DepartureAirportID" SET DATA TYPE VARCHAR(10);
