...
export default function ReportModal({ isOpen, onClose }: ReportModalProps) {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-[10000] flex flex-col items-start w-[49.25rem] max-h-[90vh] overflow-hidden rounded-[0.5rem] border-[0.25rem] border-primary-300 bg-white shadow-xl">
                {/* Header (sticky) */}
                <div className="flex w-full h-[4.5625rem] p-[0.75rem] px-[1rem] items-center gap-[0.5rem] bg-primary-300 z-10 ">
                ...
                <div className="overflow-y-auto w-full">
                    ...
                    <div className="flex w-full pt-[0.75rem] pr-[1rem] pb-[0.5rem] pl-[1rem] items-center gap-[0.5rem]">
                        <div className="font-sarabun text-primary-600 text-[1.125rem] font-semibold leading-[1.35rem]">
                            Report ID:
                        </div>
                    ...
                    <div className="flex w-[49.25rem] pt-0 pr-[1rem] pb-[1rem] pl-[1rem] items-start gap-[1rem]">
                        ...
                        <div className="flex flex-col items-start gap-[1rem]">
                            <div className="flex w-[26.25rem] p-[1rem] flex-col items-start gap-[0.75rem] rounded-[0.5rem] bg-primary-50">
                                <div className="font-sarabun text-primary-900 text-[1.5rem] font-semibold leading-[1.8rem]">
                                    Main Passenger Info
                                </div>
                                <div className="flex py-0 px-[1rem] items-start gap-[0.75rem] self-stretch">
                                    <div className="flex flex-col items-start gap-[0.5rem]">
                                        <div className="font-sarabun text-primary-600 text-[1rem] font-bold leading-[1.2rem]">
                                            Email :
                                        </div>
                                        <div className="font-sarabun text-primary-600 text-[1rem] font-bold leading-[1.2rem]">
                                            Phone Number :
                        ...
                        <div className="flex flex-col items-start gap-[1rem]">
                            ...
                            <div className="flex w-[20rem] p-[1rem] flex-col items-start gap-[0.75rem] rounded-[0.5rem] bg-primary-50">
                                <div className="font-sarabun text-primary-900 text-[1.5rem] font-semibold leading-[1.8rem]">
                                    Status and Priority Level
                                </div>
                                <div className="flex px-[1rem] py-0 items-start gap-[0.75rem] self-stretch">
