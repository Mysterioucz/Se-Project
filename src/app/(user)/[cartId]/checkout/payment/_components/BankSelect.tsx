...
const Banks: BankOption[] = [
    {
        value: "Kasikorn Bank",
        label: "Kasikorn Bank",
        image: "/payment/banks/kbank.svg",
    },
    {
        value: "Government Savings Bank",
        label: "Government Savings Bank",
        image: "/payment/banks/omsin.svg",
    },
    {
        value: "Siam Commercial Bank",
        label: "Siam Commercial Bank",
        image: "/payment/banks/scb.svg",
    },
    {
        value: "Krungthai Bank",
        label: "Krungthai Bank",
        image: "/payment/banks/ktb.svg",
    },
];
    ...
    return (
        <SelectComponent
            ...
            renderSelected={(selected) =>
                renderSelected ? renderSelected(selected, options) : selected
            } // ← แก้ให้ตรง type
        >
            {options.map((bank) => (
                <MenuItem
