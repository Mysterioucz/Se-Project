...
export default function Button({
    ...
    return (
        <button
            ...
            className={`flex items-center ${alignClasses[align]} ${width} ${height} cursor-pointer rounded-md transition-colors duration-200 disabled:cursor-not-allowed ${sizeClasses[size]} ${styleClasses[styleType]} gap-[var(--Spacing-md,16px)] py-[var(--Spacing-sm,8px)]`}
        >
            {iconStart && (
                <Image
                    src={iconStart}
