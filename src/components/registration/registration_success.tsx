...
export default function RegistrationSuccess() {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-8 pt-8">
                <div data-testid="registration-success-panel" className="flex flex-col items-center justify-center py-6 gap-8 border-1 border-black border-dashed rounded-lg w-[34.5rem] h-[12.625rem]">
            ...
            <div className="flex justify-center">
                <button
                    type="submit"
                    data-testid="registration-success-back-login-btn"
